...
class Redis_test(RedisLocust):
    ...
    class task_set(TaskSet):
        @task(10)
        def duid_data(self):
            data = self.client.Redis('kika-data-blau-redis0.intranet.com').lrange('USER_RECENT_NUM_b4b7d7cc9454464b938177d412874ce9', 0, 10)
            print(data)

        @task(0)
        def duid_tag_data(self):
            data = self.client.Redis('kika-data-blau-redis0.intranet.com').zrange('USER_RECENT_TAG_NUM_na_a1be32a10c414065a20e7b755018150c', 0, 10)
            print(data)
